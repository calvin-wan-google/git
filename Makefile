...
STD_LIB_FILE = libstdgit.a
STUB_LIB_FILE = libstubgit.a
...
#     make NO_GETTEXT=YesPlease libstdgit.a
# and link against libstubgit.a (if the default no-op functionality is fine)
# or a custom .a file with the same interface as libstubgit.a (if custom
